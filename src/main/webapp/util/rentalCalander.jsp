...
<body>
<p>Date: <input type="text" readOnly class="calander" id="startDate" name ="startDate" ></p>
<p>Date: <input type="text" readOnly class="calander" id="expireDate" name ="expireDate" ></p>
</body>
</html>